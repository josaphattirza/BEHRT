...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config, feature_dict=None):
        ...
        # # OWN EMBEDDING
        # if feature_dict['stayhour']:
        #     self.stayhour_embeddings = nn.Embedding(config.stayhour_vocab_size, config.hidden_size)
    ...
    def forward(self, word_ids, med_input_ids, triage_input_ids,
        ...
        # if self.feature_dict['stayhour']:
        #     stayhour_embed = self.stayhour_embeddings(stayhour_input_ids)
        #     embeddings = embeddings + stayhour_embed
...
class BertForMultiLabelPrediction(Bert.modeling.BertPreTrainedModel):
    ...
    def forward(self, input_ids, med_input_ids, triage_input_ids, 
                ...
                age_ids=None, seg_ids=None, posi_ids=None, attention_mask=None, labels=None):
        _, pooled_output = self.bert(input_ids = input_ids, 
                                    ...
                                    gcs_input_ids = indicator_input_ids,
