...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, word_ids, med_input_ids, age_ids, seg_ids, posi_ids):
...
class BertModel(Bert.modeling.BertPreTrainedModel):
    ...
    def forward(self, input_ids, med_input_ids, age_ids, seg_ids, posi_ids, attention_mask,
...
class BertForMultiLabelPrediction(Bert.modeling.BertPreTrainedModel):
    ...
    def forward(self, input_ids, med_input_ids, age_ids=None, seg_ids=None, posi_ids=None, attention_mask=None, labels=None):
