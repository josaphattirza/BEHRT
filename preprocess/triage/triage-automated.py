...
df_med = df_med[['subject_id','stay_id','age_on_admittance','med','disposition','revisit72','intime']]
...
med_columns_to_process = ["age_on_admittance","med","disposition","revisit72"]
...
df_final.write.parquet('automated_final')
