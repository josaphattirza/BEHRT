...
from dataLoader.NextXVisit_med_2 import NextVisit
from model.NextXVisit_med_2 import BertForMultiLabelPrediction
import warnings
...
file_config = {
    ...
    'med_vocab' : 'med2idx', 
    'train': './behrt_med_format_mimic4ed_month_based_train/',
    'test': './behrt_med_format_mimic4ed_month_based_test/',
}
...
global_params = {
    ...
    'device': 'cuda:0',
    'output_dir': 'med-next-visit',  # output dir
    'best_name': 'med-next-visit-monthbased-best', # output model name
...
pretrain_model_path = 'med-MLM/med-MLM-minvisit3-monthbased'  # pretrained MLM path
