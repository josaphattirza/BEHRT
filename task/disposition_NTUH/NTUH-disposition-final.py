...
file_config = {
    ...
    'train': './automated_NTUH_final_disposition_train/',
    'test': './automated_NTUH_final_disposition_test/',
}
...
global_params = {
    ...
    'device': 'cuda:0',
    'output_dir': 'finetune-NTUH-disposition',  # output dir
    'best_name': 'finetune-NTUH-disposition-best', # output model name
...
def evaluation(e, base_path):
    ...
    # aps, roc, output, label = precision_test(y, y_label, e, "NTUH-final/disposition/features-all-on")
...
for r in range(n_repetitions):
    ...
    base_path = f"NTUH-final/disposition/features-{features}/{r+1}"
