...
file_config = {
    ...
    'train': './automated_NTUH_disposition_train/',
    'test': './automated_NTUH_disposition_test/',
}
...
def evaluation(e):
    ...
    aps, roc, output, label = precision_test(y, y_label, e, "NTUH-6-features/disposition/MLM-LOS")
