...
from dataLoader.MLM_med_2 import MLMLoader
from torch.utils.data import DataLoader
import pandas as pd
from model.MLM_med_2 import BertForMaskedLM
...
# print(data)
Dset = MLMLoader(dataframe = data, token2idx = BertVocab['token2idx'], age2idx = ageVocab, med_token2idx=med_BertVocab['med2idx'], max_len=train_params['max_len_seq'], code='icd_code', age='age_on_admittance', med='med')
