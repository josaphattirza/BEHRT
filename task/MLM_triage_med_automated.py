...
global_params = {
    'max_seq_len': 64, # originally is 64
    'max_age': 110,
    'month': 1,
    'age_symbol': None,
...
# print(data)
Dset = MLMLoader(dataframe = data, token2idx = BertVocab['icd_code2idx'], age2idx = ageVocab, med_token2idx=BertVocab['med2idx'], triage_token2idx=BertVocab['triage2idx'], 
                 max_len=train_params['max_len_seq'], code='icd_code', age='age_on_admittance', med='med', triage = 'triage')
