...
import pandas as pd
from model.MLM_NTUH_LOS import BertForMultiTask
...
file_config = {
    ...
    'data': './automated_NTUH_lab_stayhour/',  # formated data 
    ...
    'model_path': 'NTUH-MLM-LOS', # where to save model
    'model_name': 'NTUH-MLM-LOS', # model name


    'file_name': 'NTUH-MLM-LOS-log',  # log path
}
