...
file_config = {
    ...
    'model_path': 'MLM-los-transfer', # where to save model
    'model_name': 'MLM-los-transfer', # model name
    'file_name': 'MLM-los-transfer-log',  # log path
}
...
# OWN LABEL VOCAB , since we want to predict PLOS
labelKey = ["Yes","No"]
labelVocab = {}
...
Dset = MLM_LOS_Loader(dataframe = data, token2idx = BertVocab['icd_code2idx'], age2idx = ageVocab, 
                 med_token2idx=BertVocab['icd_code2idx'], # unused in transfer
...
model_config = {
    ...
    'med_vocab_size': len(BertVocab['icd_code2idx'].keys()), # OWN EMBEDDINGS, unused in transfer
