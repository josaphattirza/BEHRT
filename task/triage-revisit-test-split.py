...
train_data.write.parquet('behrt_triage_revisit_disposition_med_month_based_train')
test_data.write.parquet('behrt_triage_revisit_disposition_med_month_based_test')   